...
1. Create IG account at [ig.com](https://www.ig.com)
2. Enable API access (IG Labs)
3. Start with **DEMO mode** (`USE_DEMO=true`)
...
1. **No mock data** - If API is down, bot stops (no trading on fake data)
2. **Demo mode default** - Always start with test account
3. **Validation** - All orders validated before sending
4. **Max limits** - Hard limits for positions and losses
5. **Logging** - All events logged for audit
...
1. **Demo account** - Run at least 1 month in demo
2. **Backtest** - Test on 5-10 years of history
...
**Version:** 1.0.0
**Creators:** Qwen2.5:14b, GLM-5:cloud & Claude
